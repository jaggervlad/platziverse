...
test.beforeEach(async () => {
  sandbox = sinon.createSandbox(); // Modelo hasMany() ORM sequelize
  ...
  AgentStub.findById.withArgs(id).returns(Promise.resolve(agentFixtures.byId(id))); // Modelo findOne Stub

  AgentStub.findOne = sandbox.stub();
  AgentStub.findOne.withArgs(uuidArgs).returns(Promise.resolve(agentFixtures.byUuid(uuid))); // Modelo findAll Stub
